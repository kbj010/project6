...
public class DeptController {
	...
	public String deptInsert(Dept dept, Model model) {
		...
		else result = -1; // 중복된 부서코드 입력하는 몰상식
	...
	@RequestMapping(value = "deptDupChk", produces = "text/html;charset=utf-8")
	@ResponseBody
	public String deptDupChk(int deptno) {
		String data = "";
		Dept dept = ds.select(deptno);
		if (dept == null) data = "사용 가능한 부서코드 입니다";
		else data = "사용중이니 다르코드 쓰세요";
		return data;
	}
}